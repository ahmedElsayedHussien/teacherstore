...
urlpatterns = [
    ...
    # دخول/خروج (قوالب افتراضية أو نضيفها تحت registration/)
    path(
        "accounts/login/",
    ...
    path(
        "dashboard/invoice/create/<int:student_id>/<int:group_id>/",
        views.create_invoice_quick,
        name="create_invoice_quick",
    ),
    ...
    # تغيير كلمة المرور (للمستخدم المُسجّل)
    path(
